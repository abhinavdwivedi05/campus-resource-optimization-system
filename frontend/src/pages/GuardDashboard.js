    ...
    <div style={pageStyle}>
      <div style={{ ...cardStyle, maxWidth: "720px" }}>
        <header style={{ marginBottom: "10px" }}>
          <h2 style={titleStyle}>Guard Dashboard</h2>
          <p style={subtitleStyle}>
            View complaints and mark them as resolved.
          </p>
        </header>

        <div style={gridStyle}>
          <Link to="/complaints" style={actionCardStyle}>
            <div style={actionTitleStyle}>View Complaints</div>
            <div style={actionDescStyle}>See all complaints and update their status to Resolved.</div>
          </Link>
        </div>
      </div>
    </div>
